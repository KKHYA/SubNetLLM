...
from lit_llama.model_globalsubnet import Block, LLaMA, LLaMAConfig, SupermaskLinear
...
def main(
    ...
    out_dir = f"out/globalsubnet/{task_name}/sparsity-{sparsity}_ratio-{ratio}"
    os.makedirs(out_dir, exist_ok=True)

    global logger
    logger = logging.getLogger(f'task-{task_name}_sparsity-{sparsity}_ratio-{ratio}')
    ...
    save_model_checkpoint(fabric, model, os.path.join(out_dir, "lit-llama-globalsubnet-finetuned.pth"))
    # state = {
